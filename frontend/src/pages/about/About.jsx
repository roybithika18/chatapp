    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-600 to-blue-500 p-4 flex items-center">
      <div className="max-w-4xl w-full mx-auto bg-white text-gray-800 rounded-xl shadow-lg overflow-hidden">
        <div className="p-6 md:p-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-4 text-center text-purple-600">
            About ChatApp
          </h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-2 sm:space-y-0 sm:space-x-4 mb-4">
            <a
              href="mailto:roybithika188@gmail.com"
              className="inline-flex items-center justify-center bg-purple-600 text-white px-6 py-2 rounded-full font-semibold transition-all hover:bg-purple-700 text-lg"
            >
              <Mail className="mr-2" size={20} />
              Email Us
            </a>
            <a
              href="https://www.linkedin.com/in/bithika-roy-73a0a3248" // Updated LinkedIn URL
              className="inline-flex items-center justify-center bg-blue-500 text-white px-6 py-2 rounded-full font-semibold transition-all hover:bg-blue-600 text-lg"
            >
